...
| [Write file](tasks/write-file)               | [make](tasks/write-file/make), [snakemake](tasks/write-file/snakemake), [nextflow](tasks/write-file/nextflow), [luigi](tasks/write-file/luigi), [airflow](tasks/write-file/airflow), [toil](tasks/write-file/toil), [cromwell](tasks/write-file/cromwell), [drake](tasks/write-file/drake) |
| [Write file cached](tasks/write-file-cached) | [make](tasks/write-file-cached/make), [snakemake](tasks/write-file-cached/snakemake), [nextflow](tasks/write-file-cached/nextflow), [luigi](tasks/write-file-cached/luigi), [cromwell](tasks/write-file-cached/cromwell)                                                                   |
