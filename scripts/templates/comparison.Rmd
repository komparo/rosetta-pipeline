...
- The module is included as a _subworkflow_, running within a separate rule of the pipeline with its own input and output. Examples: Snakemake (subworkflows), WDL (subworkflows). Related tasks: `r link_to_jobs("Module as job")`
