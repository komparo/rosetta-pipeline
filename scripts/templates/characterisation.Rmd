...
# tasks <- jsonlite::read_json("output/tasks.json", simplifyVector = T, simplifyMatrix = FALSE, simplifyDataFrame = FALSE)
...
Related tasks: `r link_to_tasks("Static vs dynamic")`
